...
@export var unit_type_id: StringName = &"basic_rifle_robot"
@export var unit_type_display_name: String = "基础步枪机器人"
@export var upgrade_ids: Array[StringName] = []
@export var upgrade_display_names: Array[String] = []
...
func make_snapshot(next_snapshot_id: StringName = &"") -> UnitBlueprint:
	...
	snapshot.unit_type_id = unit_type_id
	snapshot.unit_type_display_name = unit_type_display_name
	snapshot.upgrade_ids = upgrade_ids.duplicate()
	snapshot.upgrade_display_names = upgrade_display_names.duplicate()
